...
class Complex:
    ...
    def __add__(self,others):
        return Complex(self.real+others.real,self.imaginary+others.imaginary)
    
    def __mul__(self,others):
        return Complex(self.real*others.real-self.imaginary*others.imaginary,self.real*others.imaginary+self.imaginary*others.real)
...
def prune_small(t, n):
    ...
    while len(t.branches)>n:
        ...
        t.branches.pop(t.branches.index(max_branch))
    for b in t.branches:
        prune_small(b,n)
